...
module.exports = function (api, cbfail, cbok) {
  const Message = api.models.message;
  ...
  function saveMessageStep2(o, cbfail, cbok) {
    ...
    const data = o.data.substr(0, 500);
    new Message(
      {
        cid: o.cid,
        data: data,
  ...
  api.messageSystemLoadAfter = function (o, cbfail, cbok) {
    ...
    const query = {cid: o.cid, _id: {$gt: o.after}};
  ...
  api.messageMarkViewed = function (o, cbfail, cbok) {
    ...
    fn_api.conversIsForMe({
      ...
      const query = {cid: o.cid, viewed: false, sender: {$ne: o.uid}, _id: {$lte: o.before}};
